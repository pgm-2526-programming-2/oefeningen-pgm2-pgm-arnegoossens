function displayObscureDataFormatting(data){
...
function displayImportance(data, highImportanceCount, lowImportanceCount){
...
function displayComplexity(data, highComplexityCount, lowComplexityCount){
